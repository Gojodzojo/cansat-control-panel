import { SimProperties } from "./flightProperties";
...
let simFlightProperties: SimProperties = {
    canSatPosition: {x: 0, y: 0, z: 0},
...
const options = {
    env: {
        ...
        setFlightProperties: (
            ...
            canSatPosition: {x: positionX, y: positionY, z: positionZ},
